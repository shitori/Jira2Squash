        ...
        return new Promise((resolve, reject) => {
            this.getter
                ...
                .then((compaignContent) => {
                    this._sendWSinfoHard(
                        this.client,
                        'Find compaing Bandeaux NextGen',
                        60,
                        'Diffuse'
                    )
                    return this._getCompaignContent(
